...
const CATALOG = buildCodingEngineCatalog({ harnessReady: true, codexReady: true, codexCliReady: true, antigravityReady: true, zcodeCliReady: true, piCodingReady: true, cursorCliReady: true, claudeCodeCliReady: true })
