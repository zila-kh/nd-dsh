...
| [wip-0018](tasks/wip-0018-rust-parallel-runtime-v2.md) | P1 | **WIP** — second Rust convergence wave: 100-worker scale contract, project dev-server process ownership, then measured event/terminal retention migration; manual local validation only while Actions is parked |
