...
- [ ] Both CI jobs complete green on a non-draft pull request, so the Windows steps in blocked-0004 execute. — Gated on [wip-0013](wip-0013-windows-timing-flakes.md).
