...
2. What is the cheap decision tier — a small local model, a rules engine, or a hybrid? A deterministic rules engine needs no model call at all for the most mechanical verbs, which is the largest possible win.
